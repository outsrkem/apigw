...
func RegisterMethod(h *server.Hertz, method, host, rUrl, auth string) {
...
func NewProxyMethod(h *server.Hertz, host, rUrl, auth string) Method {
	return &method{
		H:    h,
		Host: host,
		RUrl: rUrl,
...
func (t *method) Any() {
	RegisterMethod(t.H, HttpAny, t.Host, t.RUrl, t.Auth)
}

func (t *method) Head() {
	RegisterMethod(t.H, http.MethodHead, t.Host, t.RUrl, t.Auth)
}

func (t *method) Get() {
	RegisterMethod(t.H, http.MethodGet, t.Host, t.RUrl, t.Auth)
}

func (t *method) Post() {
	RegisterMethod(t.H, http.MethodPost, t.Host, t.RUrl, t.Auth)
}

func (t *method) Delete() {
	RegisterMethod(t.H, http.MethodDelete, t.Host, t.RUrl, t.Auth)
}

func (t *method) Patch() {
	RegisterMethod(t.H, http.MethodPatch, t.Host, t.RUrl, t.Auth)
}

func (t *method) Put() {
	RegisterMethod(t.H, http.MethodPut, t.Host, t.RUrl, t.Auth)
}

func (t *method) Options() {
	RegisterMethod(t.H, http.MethodOptions, t.Host, t.RUrl, t.Auth)
}
